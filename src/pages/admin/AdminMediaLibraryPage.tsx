...
const AdminMediaLibraryPage = () => {
  ...
  const handleUploadComplete = useCallback(() => {
    console.log("AdminMediaLibrary: Upload complete, refreshing data");
  ...
  const handleRefresh = useCallback(() => {
    console.log("AdminMediaLibrary: Manual refresh triggered");
    fetchAllMedia();
  ...
  const handleDelete = useCallback(async (id: string) => {
    try {
      console.log("AdminMediaLibrary: Deleting file:", id);
      await deleteMediaItem(id);
      toast.success("Media file deleted successfully");
    } catch (error) {
      console.error("AdminMediaLibrary: Delete failed:", error);
  ...
  return (
    <MediaLoadingBoundary isLoading={isLoading}>
