...
import { Eye, EyeOff, Plus, Upload, MoveUp, MoveDown, Edit, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <PageHeader
        ...
        description="Manage the hero slider on your landing page. Control which slides are visible, their order, and content."
        actions={
