    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative flex flex-1 flex-col items-center justify-center bg-gradient-to-b from-background to-accent px-4 py-20 text-center">
        <div
          ...
          style={{
            backgroundImage:
              "url('/lovable-uploads/0926c663-31fd-4ea3-848a-93dae7f14340.png')",
          }}
        ></div>
        <div className="relative z-10 container mx-auto max-w-3xl">
          <div className="backdrop-blur-sm bg-black/30 p-8 rounded-xl">
            <h1 className="mb-4 font-playfair text-4xl font-bold leading-tight tracking-tighter sm:text-5xl md:text-6xl text-white">
              Welcome to{" "}
              <span className="bg-gradient-to-r from-glee-purple to-glee-gold bg-clip-text text-transparent">
                Glee World
              </span>
            </h1>
            <p className="mb-8 max-w-2xl text-xl text-white md:text-2xl">
