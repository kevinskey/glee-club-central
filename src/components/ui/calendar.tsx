...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-white dark:bg-gray-800 pointer-events-auto w-full", className)}
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 dark:hover:bg-gray-700 text-foreground dark:text-white w-full"
        ),
