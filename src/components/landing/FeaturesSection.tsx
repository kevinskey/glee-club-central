    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-white to-blue-50 dark:from-glee-dark dark:to-gray-900/90">
      <div className="container px-4 md:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-playfair">Glee Club Central Hub</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A comprehensive platform designed for both visitors and Glee Club members
          </p>
        </div>
