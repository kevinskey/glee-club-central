...
export function HeroSection() {
  ...
  return (
    <section className="relative bg-glee-dark py-4 sm:py-6 md:py-10 lg:py-16 xl:py-24 min-h-[300px] sm:min-h-[385px] md:min-h-[500px] lg:min-h-[600px] xl:min-h-[700px] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto px-2 md:container h-full flex items-center pt-2 sm:pt-3 md:pt-4 lg:pt-6">
        <HeroContent />
      </div>
