...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-white dark:bg-gray-900 shadow-md">
      {/* News Ticker */}
      {showNewsTicker && <NewsTicker />}
      
      {/* Main Header */}
      <div className="border-b bg-white/95 dark:bg-gray-900/95 backdrop-blur-md supports-[backdrop-filter]:bg-white/80 dark:supports-[backdrop-filter]:bg-gray-900/80">
