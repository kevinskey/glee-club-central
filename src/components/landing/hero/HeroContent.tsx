...
export function HeroContent() {
  ...
  return (
    <div className="text-white flex flex-col justify-between h-full w-full text-left pl-4 sm:pl-6 md:pl-8 lg:pl-10 py-4 sm:py-6 md:py-8 lg:py-10">
      ...
      <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-normal opacity-90 mb-8 sm:mb-10 md:mb-12 lg:mb-16 max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-2xl">
