    ...
    try {
      ...
      switch (tickerSettings.source) {
        case 'google_news_hbcu':
          rssUrl = 'https://news.google.com/rss/search?q=HBCU&hl=en-US&gl=US&ceid=US:en';
          break;
        case 'google_news_spelman':
          rssUrl = 'https://news.google.com/rss/search?q=Spelman%20College&hl=en-US&gl=US&ceid=US:en';
          break;
        case 'google_news_music':
          rssUrl = 'https://news.google.com/rss/search?q=choral%20music&hl=en-US&gl=US&ceid=US:en';
          break;
        default:
      ...
      setPreviewItems(['Sample news item 1', 'Sample news item 2', 'Sample news item 3']);
    } finally {
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => handleSettingUpdate('enabled', checked)}
            />
          </div>
          ...
          {tickerSettings.source === 'custom' && (
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleSettingUpdate('custom_url', e.target.value)}
              />
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleSettingUpdate('max_items', parseInt(e.target.value))}
            />
          </div>
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => handleSettingUpdate('scroll_speed', value)}
            >
              <SelectTrigger>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleSettingUpdate('auto_hide', checked)}
              />
            </div>
            ...
            {tickerSettings.auto_hide && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleSettingUpdate('hide_after', parseInt(e.target.value))}
                />
              </div>
            )}
          </div>
              ...
              <div className="bg-glee-columbia text-white py-1 relative">
                <div className="container flex items-center justify-center text-sm">
                  <div className="flex-1 overflow-hidden flex items-center">
                    <div className={`flex whitespace-nowrap animate-marquee-${tickerSettings.scroll_speed}`}>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="mt-1">
                <Badge variant={tickerSettings.enabled ? "success" : "secondary"}>
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                {sourceOptions.find(opt => opt.value === tickerSettings.source)?.label}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                {speedOptions.find(opt => opt.value === tickerSettings.scroll_speed)?.label}
              </p>
            </div>
          </div>
        </CardContent>
