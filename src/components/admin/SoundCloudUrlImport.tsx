  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const newItem: ImportedContent = {
        ...
        title: parsed.type === 'playlist' ? 'Imported Playlist' : 'Imported Track',
        artist: 'SoundCloud Artist',
        url: importUrl,
        trackCount: parsed.type === 'playlist' ? Math.floor(Math.random() * 20) + 5 : undefined,
      ...
      toast({
        title: "Import Failed",
        description: error instanceof Error ? error.message : "Failed to import SoundCloud content",
        variant: "destructive",
      });
    } finally {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              Paste any SoundCloud track or playlist URL to import it into your library.
              Examples: tracks, playlists, albums, or sets.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
