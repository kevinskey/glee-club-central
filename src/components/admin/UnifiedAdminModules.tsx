        ...
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center justify-between text-lg font-bold text-navy-900 dark:text-white">
            ...
            <Badge variant="secondary" className="text-xs font-medium">
              {sortedModules.length} available
            </Badge>
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-0 px-4">
          <div className="space-y-2">
            {sortedModules.map((module) => (
              ...
              >
                <div
                  className={`${module.color} text-white rounded-lg p-2 mr-3 group-hover:scale-105 transition-transform duration-200 shadow-sm flex-shrink-0`}
                >
                  {module.icon}
                </div>
