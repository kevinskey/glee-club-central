  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'body-large': ['1.125rem', { lineHeight: '1.55', letterSpacing: '-0.005em', fontWeight: '400' }],
        'body-small': ['0.875rem', { lineHeight: '1.5', letterSpacing: '-0.002em', fontWeight: '400' }],
        'label': ['0.875rem', { lineHeight: '1.4', letterSpacing: '-0.002em', fontWeight: '500' }],
        'small': ['0.75rem', { lineHeight: '1.4', letterSpacing: '0', fontWeight: '400' }],
        'caption': ['0.75rem', { lineHeight: '1.3', letterSpacing: '0.01em', fontWeight: '400' }],
        'button': ['0.875rem', { lineHeight: '1.2', letterSpacing: '-0.002em', fontWeight: '500' }],
        'button-large': ['1rem', { lineHeight: '1.2', letterSpacing: '-0.003em', fontWeight: '500' }],
        'button-small': ['0.75rem', { lineHeight: '1.2', letterSpacing: '0', fontWeight: '500' }],
      },
      colors: {
